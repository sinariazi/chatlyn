  ...
  const rules: Rule[] = [
    {
      ...
      conditions: { keywords: ["hello", "hi", "hey"] },
      actions: { type: "TEMPLATE_REPLY", template: "Welcome to our hotel! How may I assist you today?" },
      priority: 1,
      isActive: true,
    ...
    },
    {
      ...
      conditions: { keywords: ["urgent", "emergency", "asap", "immediately"] },
      actions: { type: "AI_REPLY", prompt: "Respond with urgency and empathy" },
      priority: 10,
      isActive: true,
      createdAt: new Date("2024-01-01T00:00:00Z"),
      updatedAt: new Date("2024-01-01T00:00:00Z"),
    },
    {
      ...
      trigger: "KEYWORD_MATCH",
      conditions: { keywords: ["checkout", "check out", "check-out"] },
      actions: { type: "TEMPLATE_REPLY", template: "Our standard checkout time is 11:00 AM. Late checkout may be available upon request." },
      priority: 5,
      isActive: true,
      createdAt: new Date("2024-01-01T00:00:00Z"),
      updatedAt: new Date("2024-01-01T00:00:00Z"),
